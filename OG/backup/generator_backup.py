...
def generate_ai_insights(file_path):
    ...
    try:
        ...
        prompt = """You are a financial advisor analyzing personal finance data. 
        ...
        progress_text.text("🤖 Analyzing your financial data (this may take a minute)...")
        
        # Generate response using Ollama with the available model
        response = ollama.generate(
            model='gemma3:4b',  # Using the available model
            prompt=prompt,
            options={
                'temperature': 0.7,
                'max_tokens': 2000
        ...
        if st.button("🤖 Generate AI Insights", key="ai_insights_btn"):
            with st.spinner("Analyzing your data with AI..."):
                ...
                with col2:
                    ...
                    os.unlink(pdf_path)  # Clean up the temporary PDF file
